...
But it also means that they are overestimated. Just check popular web framework are going. Which startup is using EE now? It's complicated. Sprigs goes towards Rails model now (and still doesn't have WebSockets support). Leading companies, which want to have Java stack, prefer new fresh solutions (Play, Scala etc...) - LinkedIn, Xerox. Google have their own solutions. Oracle? They took open MySQL and almost close it. Just look how they did with 5.6 release.
